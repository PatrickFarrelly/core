...
def api_recipes  (request):
    ...
    recipes_data = list(recipes.values())  # Fetching the data as a list of dictionaries
    return JsonResponse({'recipes': recipes_data}, safe=False)  # Fixed JsonResponse and variable name